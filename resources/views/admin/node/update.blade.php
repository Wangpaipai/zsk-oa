                        ...
                        <form class="cmxform form-horizontal adminex-form" id="commentForm" method="get" action="">
                            <div class="form-group">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input type="hidden" placeholder="" name="id" value="{{ $node->id }}">
                                    <input class=" form-control" name="name" type="text" placeholder="请输入节点名" value="{{ $node->name }}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-lg-1">路由名:</label>
                                <div class="col-lg-4">
                                    <input class=" form-control" name="route" type="text" placeholder="请输入路由名"  value="{{ $node->route }}"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-4">
                                    <input class=" form-control" name="remark" type="text" placeholder=""  value="{{ $node->remark }}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-lg-4 ">
                                    <div class="slide-toggle">
                                        <div>
                                            <input type="checkbox" name="status" value="1" class="js-switch" {{ $node->status ? 'checked' : '' }}/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-lg-4">
                                    <input class="form-control" name="sort" type="text" placeholder="请输入排序数值" value="{{ $node->sort }}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-lg-4 icheck">
                                    <div class="minimal-green">
                                        <div class="radio level">
                                            <input tabindex="3" value="1" type="radio"  name="level" {{ $node->level == 1 ? 'checked' : '' }}>
                                            <label>一级</label>
                                        </div>
                                    </div>
                                    <div class="minimal-green">
                                        <div class="radio level">
                                            <input tabindex="3" value="2" type="radio"  name="level" {{ $node->level == 2 ? 'checked' : '' }}>
                                            <label>二级</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group p_level  {{ $node->level == 1 ? 'hide' : 'show' }}">
                                <label class="control-label col-lg-1">所属节点:</label>
                                <div class="col-lg-4">
                                    <select name="pid" class="form-control m-bot15">
                                        @foreach($node_menu as $value)
                                            <option value="{{ $value->id }}" {{ $node->pid == $value->id ? 'selected' : '' }}>{{ $value->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-4 icheck">
                                    <div class="minimal-green">
                                        <div class="radio is_menu">
                                            <input tabindex="3" value="1" type="radio"  name="is_menu" {{ $node->is_menu ? 'checked' : '' }}>
                                            <label>是</label>
                                        </div>
                                    </div>
                                    <div class="minimal-green">
                                        <div class="radio is_menu">
                                            <input tabindex="3" value="0" type="radio"  name="is_menu" {{ $node->is_menu ? '' : 'checked' }}>
                                            <label>否</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group menu-select {{ $node->is_menu ? 'show' : 'hide' }}">
                                <label class="control-label col-lg-1">所属菜单:</label>
                                <div class="col-lg-4">
                                    <select name="menu_id" class="form-control m-bot15">
                                        @foreach($menu as $value)
                                            <option value="{{ $value->id }}" {{ $node->menu_id == $value->id ? 'selected' : '' }}>{{ $value->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
