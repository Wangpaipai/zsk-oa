                        ...
                        <form class="cmxform form-horizontal adminex-form" id="commentForm" method="get" action="">
                            <div class="form-group">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input type="hidden" placeholder="" name="id" value="{{ $user->id }}">
                                    <input class=" form-control" name="name" disabled type="text" placeholder="请输入用户名" value="{{ $user->user }}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-lg-2">
                                    ...
                                    <p class="help-block">选填，修改密码时输入</p>
                                </div>
                                <div class="col-lg-2">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-4">
                                    <input class=" form-control" name="realname" type="text" placeholder="请输入身份名称"  value="{{ $user->realname }}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-lg-4 ">
                                    <div class="slide-toggle">
                                        <div>
                                            <input type="checkbox" name="status" value="1" class="js-switch"  {{ $user->status ? 'checked' : '' }}/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-lg-4">
                                    <input class="form-control" name="email" type="text" placeholder="请输入电子邮箱" value="{{ $user->email }}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-lg-1">手机号码:</label>
                                <div class="col-lg-4">
                                    <input class=" form-control" name="phone" type="number" placeholder="请输入手机号码" value="{{ $user->phone }}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 icheck ch1">
                                    @foreach($role as $item)
                                        <div class="minimal-green checkd">
                                            <div class="checkbox">
                                                <input name="role[]" id="check-{{ $item->id }}" type="checkbox" value="{{ $item->id }}" {{ in_array($item->id,$role_id) ? 'checked' : '' }}>
