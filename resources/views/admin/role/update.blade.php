                        ...
                        <form class="cmxform form-horizontal adminex-form" id="commentForm">
                            <div class="form-group">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input type="hidden" placeholder="" name="id" value="{{ $role->id }}">
                                    <input class=" form-control" name="name" autocomplete="off" type="text" placeholder="请输入角色名" value="{{ $role->name }}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-lg-4 ">
                                    <div class="slide-toggle">
                                        <div>
                                            <input type="checkbox" name="status" value="1" class="js-switch"  {{ $role->status ? 'checked' : '' }}/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-lg-4">
                                    <input class=" form-control" name="remark" type="text" placeholder=""  value="{{ $role->remark }}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-lg-1">排序:</label>
                                <div class="col-lg-4">
                                    <input class=" form-control" name="sort" type="number" placeholder="请输入排序数值"  value="{{ $role->sort }}" />
